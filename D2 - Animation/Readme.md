...
> Reduced final Unreal Project file to submittable size by migrating the scene to a new file, deleting all unused assets, and manually reducing the quality of 2K textures.
